...
{1}
	...
	<Test name='Default' replayEnabled='false'>
		...
		[Test, ExpectedException(ExpectedException = typeof(CharonException), ExpectedMessage = "Could not start monitor \"PopupWatcher\".  Monitor 'PopupWatcher' is missing required parameter 'WindowNames'.")]
