...
namespace Charon.Core.Test
{
	public class DataModelCollector
	{
		...
		public void SetUp()
		{
			...
			Charon.Core.MutationStrategy.Mutating += new MutationStrategy.MutationEventHandler(MutationStrategy_Mutating);
		}
		...
		public void TearDown()
		{
			...
			Charon.Core.MutationStrategy.Mutating -= MutationStrategy_Mutating;
		}
