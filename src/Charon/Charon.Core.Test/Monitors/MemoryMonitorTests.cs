...
{1}
	...
	<Test name='Default' replayEnabled='false'>
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Could not start monitor \"Memory\".  Either pid or process name is required.")]
		public void TestNoParams()
		{
			Run(new Params(), false);
		}

		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Could not start monitor \"Memory\".  Only specify pid or process name, not both.")]
