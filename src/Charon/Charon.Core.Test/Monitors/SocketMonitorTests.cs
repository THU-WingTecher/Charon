...
{1}
	...
	<Test name='Default' replayEnabled='false'>
		...
		[Test, ExpectedException(ExpectedException=typeof(CharonException), ExpectedMessage="Could not start monitor \"Socket\".  Interface '::' is not compatible with the address family for Host '1.1.1.1'.")]
		...
		[Test, ExpectedException(ExpectedException = typeof(CharonException), ExpectedMessage = "Could not start monitor \"Socket\".  Multicast hosts are not supported with the tcp protocol.")]
