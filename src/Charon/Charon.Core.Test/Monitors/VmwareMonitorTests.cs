...
namespace Charon.Core.Test.Monitors
{
	...
	class VmwareMonitorTests
	{
		...
		public void TestGood()
		{
			...
			args["Vmx"] = new Variant("D:\\Virtual Machines\\Windows XP Professional (Charon)\\Windows XP Professional.vmx");
		...
		public void TestHost()
		{
			...
			args["Vmx"] = new Variant("[ha-datacenter/standard] Windows XP Professional (Charon)/Windows XP Professional.vmx");
			args["SnapshotIndex"] = new Variant("0");
			RunMonitor(args);
		}
