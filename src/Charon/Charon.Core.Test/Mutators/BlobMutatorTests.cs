...
namespace Charon.Core.Test.Mutators
{
	[TestFixture]
	class BlobMutatorTests : DataModelCollector
	{
		...
		public void TestSequentialHints()
		{
			...
			Assert.Throws(typeof(CharonException), delegate() { RunSequential(0, "badhint"); }, "Unexpected value for Hint named: BlobMutator-How");
		}
