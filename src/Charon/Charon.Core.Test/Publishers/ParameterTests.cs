...
namespace Charon.Core.Test.Publishers
{
	...
	class ParameterTests
	{
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Publisher 'testA' is missing required parameter 'req1'.")]
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Publisher 'testA1.default' is missing required parameter 'req1'.")]
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Publisher 'testA1.default' has no property for parameter 'req1'.")]
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Publisher 'good' could not set parameter 'Param_ip'.  An invalid IP address was specified.")]
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Publisher 'GetPub' has no settable property for parameter 'param'.")]
		...
		public void TestNullDefault()
		{
			...
			Assert.Throws<CharonException>(delegate() { ParameterParser.Parse(obj, onlyStr); });
		}
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Publisher 'HexString' could not set parameter 'arg'.  An invalid hex string was specified.")]
