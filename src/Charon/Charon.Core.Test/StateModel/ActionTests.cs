...
namespace Charon.Core.Test.StateModel
{
...
{1}
	...
	<Test name='Default'>
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Error, action 'action' is missing required child element <DataModel>.")]
		public void Test2()
		{
			RunAction("input", "");
		}
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Error, <Param> child of action 'action' is missing required child element <DataModel>.")]
		public void Test6()
		{
