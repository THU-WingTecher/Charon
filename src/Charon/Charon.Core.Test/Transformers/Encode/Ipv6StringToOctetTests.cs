...
namespace Charon.Core.Test.Transformers.Encode
{
    ...
    class Ipv6StringToOctetTests : DataModelCollector
    {
        ...
        public void Test1()
        {
            ...
            // verify values
            // -- this is the pre-calculated result from Charon2.3 on the blob: "3ffe:1900:4545:3:200:f8ff:fe21:67cf"
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Error, can't transform IP to bytes, '3ffe:1900:4545:3:200:f8ff:fe21' is not a valid IP address.")]
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Error, can't transform bytes to IP, expected 16 bytes but got 13 bytes.")]
		...
		[Test, ExpectedException(typeof(CharonException), ExpectedMessage = "Error, can't transform bytes to IP, expected 16 bytes but got 18 bytes.")]
