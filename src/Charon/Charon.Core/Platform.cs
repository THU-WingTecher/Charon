		...
		public static void LoadAssembly()
		{
			...
			switch (Platform.GetOS())
			{
				case Platform.OS.OSX:
					osAssembly = "Charon.Core.OS.OSX.dll";
					break;
				case Platform.OS.Linux:
					osAssembly = "Charon.Core.OS.Linux.dll";
					break;
				case Platform.OS.Windows:
					osAssembly = "Charon.Core.OS.Windows.dll";
					break;
			}
			...
			{
				throw new CharonException(string.Format("Error, could not load platform assembly '{0}'.  {1}", osAssembly, ex.Message), ex);
			}
		}
