namespace CharonFuzzBang
{
	partial class FormMain
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox6.Text = "Charon Pit (OPTIONAL)";
			// 
			// label16
			// 
			...
			this.label16.Text = "Optionally an existing Charon PIT may be loaded.  After \r\nloading Charon Pit select" +
