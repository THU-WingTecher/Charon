...
namespace CharonValidator
{
	...
	public class CrackNode
	{
		...
		public string IconName
		{
			...
			{
				if (Error)
					return "CharonValidator.icons.node-error.png";

				return "CharonValidator.icons.node-" + DataElement.GetType().Name.ToLower() + ".png";
			}
		}
		...
		public Image Icon
		{
			get
			{
				...
				if (strm == null)
					strm = asm.GetManifestResourceStream("CharonValidator.icons.node-unknown.png");
