...
namespace CharonValidator
{
	...
	{
		string windowTitle = "Charon Validator v3.0";
		string windowTitlePit = "Charon Validator v3.0 - {0}";
		string windowTitlePitSample = "Charon Validator v3.0 - {0} - {1}";
		string windowTitleSample = "Charon Validator v3.0 - None - {0}";
